  ...
  async execute(interaction) {
    ...
    if (sub === 'send') {
      ...
      modal.addComponents(
        ...
        new ActionRowBuilder().addComponents(new TextInputBuilder().setCustomId('color').setLabel('Couleur hex').setStyle(TextInputStyle.Short).setRequired(false).setValue(curColor)),
