...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('showmatch').setDescription('Annoncer un showmatch')
  ...
  async execute(interaction) {
    ...
    const assetName = isHome ? 'Show_Dom' : 'Show_Vis';
    ...
    if (imgBuffer) {
      const att = new AttachmentBuilder(imgBuffer, { name: 'showmatch.png' });
